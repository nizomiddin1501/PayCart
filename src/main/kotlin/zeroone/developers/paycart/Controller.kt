...
class TransactionController(val service: TransactionService) {
    ...
    @ApiResponses(ApiResponse(responseCode = "200", description = "Successfully fetched the transaction"),
    ...
    @ApiResponses(ApiResponse(responseCode = "201", description = "Transaction successfully created"),
        ApiResponse(responseCode = "400", description = "Invalid request data"))
    @PostMapping
    ...
    @ApiResponses(ApiResponse(responseCode = "200", description = "Transaction successfully updated"),
        ApiResponse(responseCode = "404", description = "Transaction not found"),
        ApiResponse(responseCode = "400", description = "Invalid request data"))
    @PutMapping("{id}")
    ...
    @ApiResponses(ApiResponse(responseCode = "204", description = "Transaction successfully deleted"),
        ApiResponse(responseCode = "404", description = "Transaction not found"))
    @DeleteMapping("{id}")
    fun delete(@PathVariable id: Long) = service.delete(id)
}
...
class TransactionItemController(val service: TransactionItemService) {
    ...
    @ApiResponses(ApiResponse(responseCode = "200", description = "Successfully fetched the transactionItem"),
    ...
    @ApiResponses(ApiResponse(responseCode = "201", description = "TransactionItem successfully created"),
        ApiResponse(responseCode = "400", description = "Invalid request data"))
    @PostMapping
    ...
    @ApiResponses(ApiResponse(responseCode = "200", description = "TransactionItem successfully updated"),
        ApiResponse(responseCode = "404", description = "TransactionItem not found"),
        ApiResponse(responseCode = "400", description = "Invalid request data"))
    @PutMapping("{id}")
    ...
    @ApiResponses(ApiResponse(responseCode = "204", description = "TransactionItem successfully deleted"),
        ApiResponse(responseCode = "404", description = "TransactionItem not found"))
    @DeleteMapping("{id}")
    fun delete(@PathVariable id: Long) = service.delete(id)
}
...
class UserPaymentTransactionController(val service: UserPaymentTransactionService) {
    ...
    @ApiResponses(ApiResponse(responseCode = "200", description = "Successfully fetched the userTransaction"),
    ...
    @ApiResponses(ApiResponse(responseCode = "201", description = "UserTransaction successfully created"),
        ApiResponse(responseCode = "400", description = "Invalid request data"))
    @PostMapping
    fun create(@RequestBody @Valid request: UserPaymentTransactionCreateRequest) = service.create(request)
    ...
    @ApiResponses(ApiResponse(responseCode = "200", description = "UserTransaction successfully updated"),
        ApiResponse(responseCode = "404", description = "UserTransaction not found"),
        ApiResponse(responseCode = "400", description = "Invalid request data"))
    @PutMapping("{id}")
    ...
    @ApiResponses(ApiResponse(responseCode = "204", description = "UserTransaction successfully deleted"),
        ApiResponse(responseCode = "404", description = "UserTransaction not found"))
    @DeleteMapping("{id}")
    fun delete(@PathVariable id: Long) = service.delete(id)
}
